...
const RightSideBar = () => (
  <aside class="w-64" aria-label="Sidebar">
    ...
    <div>
      <div className="block overflow-hidden w-full text-sm text-gray-900 bg-[#16181c] rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500  ">
